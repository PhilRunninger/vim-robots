...
execute 'syntax match RobotsPortalsIntro /'.g:robots_portal_intro.'/'
execute 'syntax match RobotsPortalsIntro /'.g:robots_portal_warning.'/'
...
highlight RobotsPortals         cterm=bold ctermfg=25  guifg=#005faf
highlight RobotsPortalsIntro    cterm=bold ctermfg=39  guifg=#00afff
